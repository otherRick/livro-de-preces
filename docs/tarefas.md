...
> Leia `CLAUDE.md`, `docs/projeto.md` e `docs/tarefas.md`, e abra `prototipo/layout.html` para ver a experiência de referência. Não mude decisões de produto. Comece pela Tarefa 0: proponha o framework (SvelteKit ou Next.js) em 3 linhas e, se eu aprovar, monte o projeto mantendo os arquivos existentes. Depois siga a ordem, uma tarefa por vez, e mostre como testar cada uma.
